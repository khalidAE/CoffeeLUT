        ...
        <buttON onclick="window.location= '#'">
            <div class="card">
                <div class="card-body">
                    ...
                    <i class="far fa-chart-bar card-img-top"></i>
                    <p class="card-text"></p>
                </div>
            </div>
        </buttON>

        <buttON onclick="window.location.href = 'manage-staff.php';">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Manage Staff</h4>
                    <i class="fas fa-id-card card-img-top"></i>
                    <p class="card-text"></p>
                </div>
            </div>
        </buttON>

        <buttON onclick="window.location= 'manage-customers.php'">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Manage Customers</h4>
                    <i class="fas fa-users-cog card-img-top"></i>
                    <p class="card-text"></p>
                </div>
            </div>
        </buttON>
